...
3. **Manual Frontend Verification:** For the current phase, frontend testing is performed manually. Automated unit tests are optional.
...
3. **Implementation:**
   ...
   - Adhere to the `tech-stack.md` and `code_styleguides/`.

4. **Manual Verification:**
   - Verify the changes manually in the browser or via API calls as appropriate.
   - Ensure the feature works as specified and handles edge cases.
...
9. **Commit Plan Update:**
    ...
    - **Action:** Commit this change with a descriptive message following the format `conductor(plan): Mark task 'Create user model' as complete`.
...
6.  **Get and Record Phase Checkpoint SHA:**
    ...
    -   **Step 6.3: Update Plan:** Write the updated content back to `plan.md`.
...
- [ ] All public functions/methods are documented (TypeScript types/JSDoc)
